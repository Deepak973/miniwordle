 ...
 */
export const APP_NAME = 'miniwordle';

/**
 * A brief description of the mini app's functionality.
 * Used in app store listings and metadata.
 */
export const APP_DESCRIPTION = 'A daily word-guessing challenge for Farcaster users - test your vocabulary in 6 tries!';
 ...
 */
export const APP_BUTTON_TEXT = 'Launch Mini Wordle';
